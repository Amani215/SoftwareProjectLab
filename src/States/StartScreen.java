...
public class StartScreen extends AbstractAppState {
    ...
    public void initialize(AppStateManager stateManager, Application app) {
        ...
        inputManager.addMapping("ExitFromHome", new MouseButtonTrigger(MouseInput.BUTTON_LEFT));
        inputManager.addListener(actionListener, "ExitFromHome");
        exit = false;
    }
    ...
    private final ActionListener actionListener = new ActionListener() {
        ...
        public void onAction(String name, boolean keyPressed, float tpf) {
            ...
            else if (name.equals("ExitFromHome") && keyPressed){
